...
<html lang="en">
  ...
  <body >
                  ...
                  <div class="dropdown-menu">
                    <div class="dropdown-menu-columns">
                      <div class="dropdown-menu-column">
                        <a class="dropdown-item" href="./izin_pribadi.html">
                          Izin Pribadi
                        </a>
                        <a class="dropdown-item" href="./konsultasi.html">
                          Konsultasi Dospem
                        </a>
                      </div>
                    </div>
    ...
    <!-- Libs JS -->
    <script src="./assets/libs/apexcharts/assets/apexcharts.min.js?1692870487" defer></script>
    <script src="./assets/libs/jsvectormap/assets/js/jsvectormap.min.js?1692870487" defer></script>
    <script src="./assets/libs/jsvectormap/assets/maps/world.js?1692870487" defer></script>
    <script src="./assets/libs/jsvectormap/assets/maps/world-merc.js?1692870487" defer></script>
    <!-- Tabler Core -->
