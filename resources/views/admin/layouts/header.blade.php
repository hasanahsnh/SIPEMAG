          ...
          <div class="navbar">
            <div class="container-xl">
              <ul class="navbar-nav">
				...
				<!-- Dropdown Navbar -->
					...
					<li class="nav-item dropdown {{ Request::is('pembimbing-lapangan') || Request::is('pembimbing-lembaga') || Request::is('pemagang') ? 'active' : '' }}">
						...
						<div class="dropdown-menu-columns">
							...
							<a class="dropdown-item {{ Request::is('pembimbing-lapangan') ? 'active' : '' }}" href="{{ url('pembimbing-lapangan') }}">
								Pembimbing Lapangan
							</a>
							<a class="dropdown-item {{ Request::is('pembimbing-lembaga') ? 'active' : '' }}" href="{{ url('pembimbing-lembaga') }}">
								Dosen/Guru Pembimbing
							</a>
							<a class="dropdown-item {{ Request::is('pemagang') ? 'active' : '' }}" href="{{ url('pemagang') }}">
								Pemagang
							</a>
							</div>
						</div>
				...
				<li class="nav-item {{ Request::is('rekap-kehadiran') ? 'active' : '' }}">
...
<html lang="en">
  ...
  <body>
    ...
    <div class="page">
              ...
              <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown">
                  ...
                  <div class="dropdown-menu">
                    <div class="dropdown-menu-columns">
                      <div class="dropdown-menu-column">
                        <a class="dropdown-item" href="{{ url('pembimbing-lapangan') }}">
                          <span class="nav-link-icon d-md-none d-lg-inline-block">
                        ...
                        <a class="dropdown-item" href="{{ url('pembimbing-lembaga') }}">
                          <span class="nav-link-icon d-md-none d-lg-inline-block">
                            <svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-user-check"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M8 7a4 4 0 1 0 8 0a4 4 0 0 0 -8 0" /><path d="M6 21v-2a4 4 0 0 1 4 -4h4" /><path d="M15 19l2 2l4 -4" /></svg>
                          </span>
                          Dosen/Guru Pembimbing
                        </a>
                        <a class="dropdown-item" href="{{ url('pemagang') }}">
                          <span class="nav-link-icon d-md-none d-lg-inline-block">
                            <svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-user-check"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M8 7a4 4 0 1 0 8 0a4 4 0 0 0 -8 0" /><path d="M6 21v-2a4 4 0 0 1 4 -4h4" /><path d="M15 19l2 2l4 -4" /></svg>
                          </span>
                          Pemagang
	  ...
	  <div class="container-fluid">
        @yield('pembimbing-lap-content')
      </div>

	  <div class="container-fluid">
        @yield('pembimbing-lembaga-content')
      </div>
      
	  <div class="container-fluid">
        @yield('pemagang-content')
      </div>

	  <div class="container-fluid">
        @yield('rekap-kehadiran-content')
      </div>
